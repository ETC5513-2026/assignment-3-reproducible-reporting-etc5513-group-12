...
This study examines pedestrian movement patterns in Melbourne during the summer period from 1 December 2025 to 28 February 2026. Data was obtained from the City of Melbourne Pedestrian Counting System, which records pedestrian activity through sensors located throughout the city. The dataset was filtered to include only observations within this period, as it corresponds to the university summer break when movement patterns may differ from the rest of the year.
...
@tbl-summary presents summary statistics for pedestrian counts during the selected period. @fig-top-sensors shows the ten sensor locations with the highest average pedestrian counts.
